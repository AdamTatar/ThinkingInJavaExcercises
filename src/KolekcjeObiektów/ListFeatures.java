...
public class ListFeatures {
  ...
  public static void main(String[] args) {
    ...
    // Potrzebny dok³adnie ten egzemplarz:
    ...
    // W containsAll() kolejnoœæ jest nieistotna:
    ...
    copy = new ArrayList<Pet>(pets); // Œwie¿a kopia
    copy.remove(2); // Usuwanie przez indeks
    System.out.println("14: " + copy);
    copy.removeAll(sub); // Usuwanie jedynie dok³adnie takich egzemplarzy
    System.out.println("15: " + copy);
    copy.set(1, new Mouse()); // Zast¹pienie elementu
    System.out.println("16: " + copy);
    copy.addAll(2, sub); // Wstawienie listy w œrodek
    System.out.println("17: " + copy);
    System.out.println("18: " + pets.isEmpty());
    pets.clear(); // Usuniêcie wszystkich elementów
